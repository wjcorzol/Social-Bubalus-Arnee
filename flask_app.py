...
from db import consulta_accion, consulta_selecion, consulta_selecion_rowcount
...
def inicio():
    ...
    if request.method == "GET":
        ...
        sql = f"SELECT * FROM tabla_usuario WHERE usuario='{usuario}'"
        # Ejecutar la consulta
        res = consulta_selecion_rowcount(sql)
        #tomar decisiones
        print(res)
